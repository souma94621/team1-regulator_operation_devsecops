...
class OperatorHandler:
    ...
    async def handle(self, message: dict):
        try:
            ...
            # Здесь можно добавить проверку подписи запроса
            # if not self.verify_signature(req.digital_signature, req.operator_id):
            #     reject...
            ...
            result = OperatorResult(
                ...
                digital_signature=cert.digital_signature  # или подпись регулятора
            )
            await self.broker.publish(Config.TOPIC_OPERATOR_RESULT, result.dict())
